...
// the_worst_one.bundle.Bundle handles simple string loading and also holds custom the_worst_one.bundle control
class Bundle(val locale: String = "en_US") {
    ...
    // get returns key from called the_worst_one.bundle or default the_worst_one.bundle or returns message that key is missing
    fun get(key: String): String {
        val v = if (bundle.containsKey(key))
            ...
            "the_worst_one.bundle key $key is missing, please bother the developer"
